...
/** IMU **/
    ...
    #if defined(USE_ACC_ICM42605)
        BUSDEV_REGISTER_SPI(busdev_icm42605,      DEVHW_ICM42605,       ICM42605_SPI_BUS,     ICM42605_CS_PIN,      NONE,           DEVFLAGS_NONE);
    #endif
...
/** BAROMETERS **/
    ...
    #endif
    BUSDEV_REGISTER_I2C(busdev_spl06,      DEVHW_SPL06,       SPL06_I2C_BUS,     0x76,               NONE,           DEVFLAGS_USE_RAW_REGISTERS);
#endif
