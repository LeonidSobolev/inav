...
#ifdef NAV_BLACKBOX
    blackboxCurrent->navState = navstate;
    blackboxCurrent->navFlags = voltage_error_flag;
    blackboxCurrent->navEPH = cur_pos.is_use_airspeed;
    blackboxCurrent->navEPV = 0;
    for (int i = 0; i < XYZ_AXIS_COUNT; i++) {
        blackboxCurrent->navPos[i] = 0;
        blackboxCurrent->navRealVel[i] = 0;
        blackboxCurrent->navAccNEU[i] = 0;
        blackboxCurrent->navTargetVel[i] = 0;
        blackboxCurrent->navTargetPos[i] = 0;
    }
    blackboxCurrent->navPos[2] = cur_pos.h;
    blackboxCurrent->navTargetPos[2] = cur_pos.need_h;
    blackboxCurrent->navRealVel[2] = cur_pos.alt_thro_pid_res;
    blackboxCurrent->navTargetVel[2] = cur_pos.thro_pid_res;

    blackboxCurrent->navSurface = 0;
    blackboxCurrent->navTargetSurface = 0;
#endif
}
