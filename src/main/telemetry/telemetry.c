...
#endif
#if defined(USE_TELEMETRY_GT)
    handleGTTelemetry(currentTimeUs);
#endif
...
//#if defined(USE_TELEMETRY_XLOGGER)
//    handleXLoggerTelemetry(currentTimeUs);
//#endif
}
